...
function Login() {
  ...
  const valuePassword = (e) => {
    setInputpending_(false), setInput_(true), setPass(e.target.value);
  };
        ...
        <div className={css.content_right}>
          <div className={css.content_form}>
            ...
            <div className={css.email}>
              ...
              <input type="email" name="email" id="" value={email} onChange={valueEmail} placeholder="Enter your e-mail" />
            </div>
            <div className={css.password}>
              <i className={`fa-solid fa-lock ${inputpending_ ? "text-secondary" : input_ ? "text-primary" : "text-danger"}`}></i>
              <input type={type} name="password" id="" value={pass} onChange={valuePassword} placeholder="Enter your password" />
