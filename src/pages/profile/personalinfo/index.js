            ...
            <div className={""}>
              <div className={css.content_edit}>
                <div>
                  ...
                  <p className={css.personal_desc}>We got your personal information from the sign up proccess. If you want to make changes on your information, contact our support.</p>
                </div>
                <div
              ...
              <div className={css.box_input}>
                <p>First Name</p>
                <input type="text" placeholder="Input firstname" value={firstName} onChange={handleFirstname} disabled={edit} />
              </div>
              <div className={css.box_input}>
                <p>Last Name</p>
                <input
              ...
              <div className={css.box_input}>
                <p>Verified E-mail</p>
                <input type="email" name="" placeholder="Input email" value={email} disabled className="text-muted" />
              </div>
              <div className={css.box_input_number}>
                <div className={css.phone_number}>
                  <p>Phone Number</p>
                  <input type="number" name="" id="" placeholder="Input phone number" disabled value={noTelp} />
                </div>
